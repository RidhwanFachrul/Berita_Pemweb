        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4">
                    <div class="logo">
                        <a href="">
                            <img src="{{ asset('newstemplate/img/logoku.png') }}" alt="Logo">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>&copy; <a href="https://github.com/RidhwanFachrul/"></a>Baca Berita Banyak Manfaat</p>
                </div>
                <div class="col-md-6 template-by">
                    <p>Copyright by <a href="https://github.com/RidhwanFachrul/">Ridhwan Fachrul Arief</a></p>
                </div>
            </div>
        </div>
    </div>
